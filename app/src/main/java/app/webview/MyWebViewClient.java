...
import app.WebActivity;
import app.TinyTools;
...
public class MyWebViewClient extends WebViewClient {
    ...
    public void onPageStarted(WebView view, String url, Bitmap favicon) {
        ...
        WebActivity.loadingView.setVisibility(View.VISIBLE);
    }
    ...
    public void onPageFinished(WebView view, String url) {
        ...
        if (!TinyTools.isNetworkConnected(mActivity)) {
            mIWebPageView.hindProgressBar();
        }
        // html加载完成之后，添加监听图片的点击js函数
        mIWebPageView.addImageClickListener();
        super.onPageFinished(view, url);
        WebActivity.loadingView.setVisibility(View.INVISIBLE);
    }
